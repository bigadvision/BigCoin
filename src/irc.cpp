...
// Copyright (c) 2011-2012 BigCoin Developers
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #BigCoinTEST0\r");
            Send(hSocket, "WHO #BigCoinTEST0\r");
        } else {
            ...
            Send(hSocket, strprintf("JOIN #BigCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #BigCoin%02d\r", channel_number).c_str());
        }
